...
namespace FTRGames.Alpaseh.Scenes
{
    public class Credits : MonoBehaviour
    {
        ...
        {
            companyText.text = LocalizationManager.GetLocalizationData().Credits.CompanyText;
            developerText.text = LocalizationManager.GetLocalizationData().Credits.DeveloperText;
            versionText.text = LocalizationManager.GetLocalizationData().Credits.VersionText + Application.version;
            mainMenuButtonText.text = LocalizationManager.GetLocalizationData().Credits.MainMenuButtonText;
        }
    }
}
