...
public class GameService 
{
    ...
    private readonly WordNumberConverter wordNumberConverter;
    ...
    public GameService(AudioService audioService, WordParser wordParser, LocalizationService localizationService, LevelService levelService, 
        WordNumberConverter wordNumberConverter, GameView gameView, AudioView audioView, TweenService tweenService, ScoreService scoreService)
    {
        this.audioService = audioService;
        this.wordParser = wordParser;
        this.localizationService = localizationService;
        this.levelService = levelService;
        this.wordNumberConverter = wordNumberConverter;
    ...
    private void ControlBtnClick()
    {
        bool isCorrectAnswer = levelService.Levels[levelService.ActiveLevelIndex].CheckEnteredNumberWord(gameView.enteredNumberWordText.text, 
            wordNumberConverter.GetNumbersFromWord(gameView.questionText.text));
